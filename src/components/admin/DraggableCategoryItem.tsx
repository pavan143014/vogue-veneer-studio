...
export function DraggableCategoryItem({
  ...
  // Make the item a drop target (to become a child of this category)
  const { isOver, setNodeRef: setDropRef } = useDroppable({
    id: `drop-into-${category.id}`,
    data: {
    ...
    <div className="space-y-1">
      ...
      >
        <motion.div
          ...
          animate={{ opacity: 1 }}
          className={cn(
            "flex items-center gap-2 p-3 rounded-xl bg-muted/50 group hover:bg-muted transition-colors",
